...
//....................End......................................
  ...
  Future createData() async {
    ...
    var params = {
      ...
      "CurrentUser": personid,
      "SolarCellDetails": {
        "LotNo": productSpecsController.text,
        "SupplierName": productBatchNoController.text,
        "InvoiceNo": partyNameController.text,
        "InvoiceDate": packingDate,
        "RawMaterialSpecs": reportNumberController.text,
      ...
      "SolarCell": {
        "Packaging": {
          "Characterstics": visualParametersController930.text,
          "MeasuringMethod": visualParameterCrietrion1Controller930.text,
          "Sampling": visualParameterS1Controller930.text,
          "SampleSize": numberOfPackagingSampleFields,
          "AcceptanceCriteria": visualParameterS1RemarksControllers930.text,
