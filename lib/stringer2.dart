...
class stringer2 extends StatefulWidget {
  final String? id;
  stringer2({this.id});
  @override
  _stringer2State createState() => _stringer2State();
}

class _stringer2State extends State<stringer2> {
  ...
  Future setApprovalStatus() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (objData['success'] == false) {
        ...
        Toast.show("Stringer 2 Test $approvalStatus .",
            duration: Toast.lengthLong,
            gravity: Toast.center,
  ...
  uploadPDF(List<int> referenceBytes) async {
    ...
    try {
      if (_response?.statusCode == 200) {
        ...
        Toast.show("Stringer 2 Test Completed.",
            duration: Toast.lengthLong,
            gravity: Toast.center,
            backgroundColor: AppColors.blueColor);
        Navigator.of(context).pushReplacement(MaterialPageRoute(
