...
class TestingCard extends StatefulWidget {
  TestingCard({Key? key}) : super(key: key);

  @override
  _WelcomePageState createState() => _WelcomePageState();
}

class _WelcomePageState extends State<TestingCard> {
  String? firstname,
      designation,
      department,
      lastname,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                    child: tabDashboard('BusBar Peel', AppAssets.busbar, () {
                  Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
                          builder: (BuildContext context) => busbar()),
                      (Route<dynamic> route) => false);
                })),
                SizedBox(
                  width: 10,
