...
class StringersCard extends StatefulWidget {
  StringersCard({Key? key}) : super(key: key);

  @override
  _WelcomePageState createState() => _WelcomePageState();
}

class _WelcomePageState extends State<StringersCard> {
  String? firstname,
      designation,
      department,
      lastname,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                    child: tabDashboard('Stringer 1', AppAssets.Stringer1, () {
                  Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
                          builder: (BuildContext context) => stringer1()),
                      (Route<dynamic> route) => false);
                })),
                SizedBox(
                  width: 10,
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                    child: tabDashboard('Stringer 2', AppAssets.Stringer2, () {
                  Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                    child: tabDashboard('Stringer 3', AppAssets.Stringer3, () {
                  Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
                          builder: (BuildContext context) => stringer3()),
                      (Route<dynamic> route) => false);
                })),
                SizedBox(
                  width: 10,
