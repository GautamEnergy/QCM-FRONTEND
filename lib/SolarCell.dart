...
// Packaging
  TextEditingController packagingReasonController = new TextEditingController();
...
// Visual
  ...
  Future getdata(String phone, BuildContext context) async {
    ...
    var params = {"Mobile": phone, "AppType": widget.appName};
                                  ...
                                  SingleChildScrollView(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        if (packagingResult == "Fail")
                                          const SizedBox(
                                            height: 10,
                                          ),
                                        if (packagingResult == "Fail")
                                          const Center(
                                              child: Text("REJECTION NOTE",
                                                  style: TextStyle(
                                                      fontSize: 18,
                                                      color: Color.fromARGB(
                                                          255, 141, 5, 16),
                                                                  ...
                                                                  children: <Widget>[
                                                                    ...
                                                                    TextFormField(
                                                                        ...
                                                                        validator:
                                                                            MultiValidator([
                                                                          RequiredValidator(
                                                                              errorText: "Please Enter Sample Size.")
                                                                        ])
                                                                        // bikki
                                                                        ),
                                                                    const SizedBox(
                                                                    ...
                                                                    _isLoading
                                                                        ...
                                                                        : AppButton(
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              selectedVerificationTestValues = List<bool>.generate(numberOfVerificationSampleFields, (index) => false); // Initialize all radio button values to false
                                                                              // selectedPhysicalTestValues[0] = true; // Initially select the first option
